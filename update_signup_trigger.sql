-- =============================================================================
-- UPDATE REGISTRATION TRIGGER
-- Run this script in Supabase SQL Editor to support Phone and Status fields
-- =============================================================================
...
BEGIN
    ...
    -- Extract status, allow it to be set from metadata, otherwise default to 'pending'
